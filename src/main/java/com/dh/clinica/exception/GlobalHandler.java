...
public class GlobalHandler {
    ...
    @ExceptionHandler(NewBadRequestException.class)
    public ResponseEntity<ApiError> manejarExcepcionesBadRequest(NewBadRequestException e, HttpServletRequest request){
        ApiError apiError = new ApiError(
                request.getRequestURI(),
                e.getMessage(),
